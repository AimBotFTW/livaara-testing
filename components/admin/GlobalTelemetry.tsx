  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 md:mb-12">
      ...
      <div className="glass-card p-6 md:p-8 rounded-[24px] relative overflow-hidden group">
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          {metrics.revenueChangePercent !== null && (
            <span className={`flex items-center gap-1 text-[12px] font-bold px-2 py-1 rounded-lg ${metrics.revenueChangePercent >= 0 ? "text-green-400 bg-green-400/10" : "text-red-400 bg-red-400/10"}`}>
        ...
        <h3 className="text-on-surface-variant text-[12px] font-bold uppercase tracking-widest mb-1">Total Revenue</h3>
      ...
      <div className="glass-card p-6 md:p-8 rounded-[24px] relative overflow-hidden group">
        ...
        <h3 className="text-on-surface-variant text-[12px] font-bold uppercase tracking-widest mb-1">Total Orders</h3>
        <p className="text-[24px] md:text-[32px] font-display-lg font-bold text-on-surface tracking-tight leading-none">
      ...
      <div className="glass-card p-6 md:p-8 rounded-[24px] relative overflow-hidden group">
        ...
        <h3 className="text-on-surface-variant text-[12px] font-bold uppercase tracking-widest mb-1">Inventory</h3>
        <p className="text-[24px] md:text-[32px] font-display-lg font-bold text-on-surface tracking-tight leading-none">
      ...
      <div className="glass-card p-6 md:p-8 rounded-[24px] relative overflow-hidden group">
        ...
        <h3 className="text-on-surface-variant text-[12px] font-bold uppercase tracking-widest mb-1">Customers</h3>
        <p className="text-[24px] md:text-[32px] font-display-lg font-bold text-on-surface tracking-tight leading-none">
